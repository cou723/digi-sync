...
// DigisyncEventsでは詳細欄に #created_by_dp2gc が含まれているイベントのみを取得する
async function getAllDigisyncEvents(session): Promise<Map<CalendarId, Event[]>> {
...
async function deleteEvent(delete_event_url_list, session, progressSetter) {
...
async function getAllCalendars(session) {
